...
class OtherUserProfilePage extends StatefulWidget {
 final  String? chatId;
 final  String? userId;
  const OtherUserProfilePage({Key? key,this.chatId,this.userId}) : super(key: key);
      ...
      body:(userLoaded)?Container(
        ...
        child: Column(
          ...
          children: [
           ...
           Spacer(),
            (!user!.isOnline!)?Text('last seen: ${user!.lastOnline!.hour}:${(user!.lastOnline!.minute)/10}${(user!.lastOnline!.minute)%10} on ${user!.lastOnline!.day}/${user!.lastOnline!.month}/${user!.lastOnline!.year}'):const SizedBox(height: 0,width: 0,),



            Text((index!=-1)?savedUsers[index]:user!.name!,
            ...
            Spacer(),
            Text('${user!.phoneNo.substring(0,3)} ${user!.phoneNo.substring(3)}',
            style: const TextStyle(
              fontSize: 28,
